...
class Solution:
    def maxProfit(self, prices):
        ...
        for num in prices:
            ...
            # If profit increases or stays same, update profit
            if num - min_cost >= max_profit:
                max_profit = num - min_cost

            # Else, update min_cost as current value num
            # Add current profit to total_profit
            # Update current profit to zero
            else:
                min_cost = num
